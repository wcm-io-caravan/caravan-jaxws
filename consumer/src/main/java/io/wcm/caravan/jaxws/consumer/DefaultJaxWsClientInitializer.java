 ...
 */
@ConsumerType
public class DefaultJaxWsClientInitializer implements JaxWsClientInitializer {
   ...
   * Constructor
   */
  public DefaultJaxWsClientInitializer() {
   ...
   */
  public DefaultJaxWsClientInitializer(String username, String password) {
   ...
   */
  private TLSClientParameters getTLSClientParameters() throws IOException, GeneralSecurityException {
   ...
   */
  public boolean isIgnoreUnexpectedElements() {
   ...
   *          If the SOAP server returns unknown XML element they are ignored during validation.
   */
  public void setIgnoreUnexpectedElements(boolean value) {
   ...
   */
  public String getWSAdressingUrl() {
   ...
   */
  public void setWSAdressingUrl(String value) {
   ...
   */
  public void setTimeoutConnection(int value) {
   ...
   */
  public void setTimeoutReceive(int value) {
   ...
   */
  public void setCertstorePath(String value) {
   ...
   */
  public void setCertstorePassword(String value) {
